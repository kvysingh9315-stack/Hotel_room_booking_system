...
- Add a user-friendly menu and repeat booking option
- Improve room inventory persistence across runs
- Replace hard-coded payment details with configurable settings

---

`Room_booking_system.py` is an easy-to-understand example of a practical booking application implemented in Python.